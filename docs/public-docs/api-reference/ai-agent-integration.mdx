...
If the key is not in your shell yet, set it before running setup:
...
For a one-command local install, you can pass the key directly. This is
convenient, but the value may remain in shell history:
