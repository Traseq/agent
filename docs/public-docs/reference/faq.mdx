...
platform, including a small Public Agent API key quota. Paid plans (Plus, Pro,
and Team) add more monthly research credits, larger API key quotas, viewer
access, and collaboration capacity.
