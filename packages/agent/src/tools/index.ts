...
export const tools = {
  ...
  asMarkdown(): string {
    ...
    return [
      ...
      '',
      'Lower-level order remains available for automation: get_manifest, get_workspace_context, get_usage, get_capabilities, resolve_strategy_semantics, assemble_signal_graph, preflight_strategy_draft, validate_strategy, create/finalize, run_backtest, then get/wait results.',
      '',
      '## Agent-Local Tools',
      '',
      ...localDefs.map((tool) =>
